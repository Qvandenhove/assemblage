...
const TestSwiper:React.FC = () => {
    ...
    return (
        <Swiper className="questionnaire" preloadImages={true} updateOnImagesReady={true} onSwiper={(swiper) => {slider = swiper}} allowTouchMove={false} effect="flip" pagination id="main" >
